		...
		<div className="mtd-page">
			<section className="section-1 hero d-flex flex-column position-relative">
				<div
					...
					<Images
						large="https://www.cubcadet.com/on/demandware.static/-/Sites-cubcadet-Library/default/veed3207c3f180871c2fe63844e18adc185f28147/snow-v2/Mask%20Group%2034.png"
						small="https://www.cubcadet.com/on/demandware.static/-/Sites-cubcadet-Library/default/veed3207c3f180871c2fe63844e18adc185f28147/snow-v2/Mask%20Group%2054.png"
					/>
				</div>
				<div className="position-lg-absolute w-100 pt-4" style={{ zIndex: 11 }}>
					<div
						className="wrapper d-flex flex-column align-items-end"
						style={{
							bottom: "20px",
						}}>
						<CubDaysBlock />
