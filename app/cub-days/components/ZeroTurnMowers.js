import IconCubDays from "../../../components/images/IconCubDays.js";
						...
						<li className="col-12 col-lg-7 bg-secondary">
							<div className="p-3">
								<h2 className="mb-2 display-2">
									Introducing the Ultima Series<sup>™</sup> ZTXS
								</h2>
								...
								<p className="mb-2" style={{ lineHeight: "1.8" }}>
									...
									challenges. The Ultima ZTXS brings Cub Cadet’s innovative and
									proprietary Synchro-Steer<sup>™</sup>
									technology to the proven Ultima Series<sup>™</sup> platform
									for reliable precision and confident control.
								</p>
								<a
					...
					<ul className="list-unstyled d-flex flex-column flex-lg-row flex-wrap justify-content-center">
						<li className="col-12 col-lg-4 p-2">
							<div
								...
								<ul className="list-unstyled d-flex">
									<li className="col-3 p-2">
										<img
											...
											className="w-100"
										/>
										<p className="small text-center mt-1 mb-0">Up to 5 acres</p>
									</li>
									<li className="col-3 p-2">
										<img
											alt=""
								...
								<a
									href="https://www.cubcadet.com/en_US/search?cgid=zero-turn-mowers-lp-zt"
						...
						<li className="col-12 col-lg-4 p-2">
							<div
								...
								<p className="mb-2" style={{ lineHeight: "1.8" }}>
									...
									lithium-ion battery technology for a quiet operation, run time
									up to 1.5 hours of run time and limited power fade.
								</p>
								<ul className="list-unstyled d-flex">
									<li className="col-3 p-2">
										<img
								...
								<a
									href="https://www.cubcadet.com/en_US/electric-lawn-mowers/zt1-42e/34BBA2CS710.html"
									className="button text-uppercase font-weight-bold text-decoration-none d-inline-block border-0 bg-black mb-0 text-center w-100 mt-auto"
									style={{ padding: "0.625rem 2.5rem" }}>
									Shop Now
								</a>
						...
						<li className="col-12 col-lg-4 p-2">
							<div
								...
								<p className="mb-2" style={{ lineHeight: "1.8" }}>
									Equipped with Cub Cadet® Synchro-Steer™ Technology, the Ultima
									ZTS line delivers precision, control and stability on hills up
									to 20 degrees.
								</p>
								<ul className="list-unstyled d-flex">
									<li className="col-3 p-2">
								...
								<a
									href="https://www.cubcadet.com/en_US/lp/ultima-zts--zero-turn-mowers"
									className="button text-uppercase font-weight-bold text-decoration-none d-inline-block border-0 bg-black mb-0 text-center w-100 mt-auto"
									style={{ padding: "0.625rem 2.5rem" }}>
									Shop Now
								</a>
						...
						<li className="col-12 col-lg-4 p-2">
							<div
								...
								<a
									href="https://www.cubcadet.com/en_US/lp/ztx--zero-turn-mowers"
									className="button text-uppercase font-weight-bold text-decoration-none d-inline-block border-0 bg-black mb-0 text-center w-100 mt-auto"
									style={{ padding: "0.625rem 2.5rem" }}>
									Shop Now
								</a>
