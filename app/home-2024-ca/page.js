      ...
      <div className="px-1 pt-1 px-md-3 pt-md-3 max-w-[1536px] mx-auto">
        <HomeCTA2024
          ...
          content={{
            ...
            title: "Dominate Hills And Slopes",
            // subTitle: `20% Off Fleet discount. Valid March 1-31, 2024.`,
            copy: `Tackle tough hills and slopes (up to 20 degrees) with the Ultima Series® ZTXS line of zero-turn lawn mowers fitted with our Synchro-Steer™ steering wheel technology. The ZTXS features a commercial-grade deck and engine designed to deliver consistent quality you can depend on.`,
            hero: true,
          }}
          button={{
            title: "Learn More",
