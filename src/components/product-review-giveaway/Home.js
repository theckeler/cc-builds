	...
	return (
		<div className="container">
			...
			<p>
				...
				living in the same household (related or not) of Sponsor, or their
				affiliates (individually and collectively, “Giveaway Entities”) are not
				eligible to enter.
			</p>
			<p>
			...
			<p>
				...
				VERIFIED AND ENTRANT HAS BEEN ADVISED BY SPONSOR THAT VERIFICATION IS
				COMPLETE.
			</p>
			<p>
			...
			<p>
				...
				devised, in perpetuity, without further compensation or authorization
				(except where prohibited by law) and the Winner releases Sponsor from
			...
			<p>
				...
				suppliers and all individuals and entities involved in fulfilling,
				administering, advertising or promoting this Giveaway and each of their
				respective past and present officers, directors, parent companies,
				subsidiaries, affiliates, employees, representatives, licensees and
				agents (collectively, “Released Parties”) from any and all claims,
				expenses, liabilities, personal injury, death, illness, property loss,
				litigation or damages of any kind to persons and/or property (including
			...
			<p>
				...
				time may have materially affected their decision to enter this Giveaway.
				Such entrants acknowledge and agree that by reason of these Official
				Rules, and the release contained in the preceding subsections, they are
				assuming any risk of such unknown facts and such unknown and unsuspected
				claims. Such entrants acknowledge that they have read these Official
				Rules and, as such, hereby have been advised of the existence of Section
			...
			<p>
				...
				to any degree impaired the integrity, administration, security, proper
				play and/or feasibility of this Giveaway as contemplated herein. If an
				insufficient number of eligible Entries are received and/or Sponsor is
				prevented from awarding the prize or continuing with this Giveaway as
				contemplated herein by any event beyond its control, including but not
				limited to fire, flood, natural or man-made epidemic of health or other
				means, earthquake, explosion, labor dispute or strike, act of God or
				public enemy, satellite or equipment failure, riot or civil disturbance,
				terrorist threat or activity, or any federal, state or local government
				law, order, or regulation, public health crisis, pandemic (e.g.
